<div class="ourprojectrow">
  ...
  <div>
    <img src="pictures/LC3boys.jpg" alt="" width="300" height="225" class="project-img" />
    <p>Learn about "Honors" option here: <a href="GeneralDoc/Honors Credit Directions 1718.pdf">Honors Details</a></p> <br/>
    <p>Grades: 9-12</p> <br />
    ...
    <p>*Instructor can work with parents on any potential class name to fit transcripts. </p>
    ...
    <br/>
    <br/>
    Perrine text not included in price of class; it is usually about $10, used.
    <br/>
    <i>Outcasts United</i> is available used or at the library, or through an order instructor will make.
    <br/>
    </p>

    <div style="font-weight:bold;" class="clear">
      <img src="images/arrow.png" alt="" width="16" height="16" border="0" />
      <a target="_blank" href="MultiLit/1718 ML Formal Descript.pdf">Formal Course Description</a>
    </div>
    <div style="font-weight:bold;" class="clear">
      <img src="images/arrow.png" alt="" width="16" height="16" border="0" />
      <a target="_blank" href="MultiLit/Syllabus Multi Lit 1718.pdf">Syllabus</a>
    </div>
    <div style="font-weight:bold;" class="clear">
      <img src="images/arrow.png" alt="" width="16" height="16" border="0" />
      <a target="_blank" href="GeneralDoc/Honors Credit Directions 1718.pdf">Honors Details</a>
    </div>
    <br />
  </div>
</div>

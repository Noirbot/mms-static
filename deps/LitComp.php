       <div class="ourprojectrow">
			...
			<p>Units of <b><i>literature</i></b> focus on short stories, poetry, visual media, and nonfiction, including <i>Outcasts United</i>, teacher handouts, Internet resources, and works from Perrine's <i>Literature: Structure, Sound, and Sense</i> (ISBN 0155511084). Students are taught the rhetorical framework of fiction and nonfiction, investigating literary analysis skills one can build on for future AP classwork if desired. Optional, extra-credit summer reading can contribute to literature requirements and may cover August classwork if parents desire to start the course before Labor Day.</p>
        ...
        Tuition:
        <ul>
          <li>Eastside (LAC) - $70 per month, Sept-May</li>
      ...
      <div style="font-weight:bold;">
        <img src="images/arrow.png" alt="" width="16" height="16" border="0" />
        <a target="_blank" href="GeneralDoc/MAS Fees 1516.pdf">MAS Fees and Discounts</a>
        <div class="clear"></div>
      </div> -->
	    <br />
		</div>

<?php include('deps/m_header.php'); ?>
  ...
  <div class="ourprojectrow">
    <h6>Should I supplement my child's work in your class with grammar and vocab study?</h6>
    <p>
 ...
 <p>
  ...
  <div class="ourprojectrow">
      <h6>Do you write letters of reference for students? </h6>
      <p>
      ...
      <div class="ourprojectrow">
            <h6>How do you accommodate special needs students? </h6>
			<p>
	  ...
	  <div class="ourprojectrow">
            <h6>Do you give discounts on class fees? </h6>
			<p>
	  ...
	  <div class="ourprojectrow">
            <h6>Where do we get textbooks? </h6>
			<p>
	  ...
	  <div class="ourprojectrow">
			...
			<p>
			The GA Department of Education assigns course numbers to public school classes. Many accredited hybrid programs also use these numbers.</a>
			</p> <br />
 		</div>
	  <div class="ourprojectrow">
            <h6>Do you grade papers and give tests? </h6>
			<p>
			Yes--I actually enjoy giving feedback to students, having conversations with them right on their assignments as well as in informal conferences. I grade all of my students' work myself, tracking the progress of each student and building relationships because I care about what each one does in my class. Through Gradebook, I provide constant grade averages, based on plenty of assignments evaluated and returned weekly.
			</p> <br />
 		</div>
     <div class="ourprojectrow">
            <h6>How do your students behave?</h6>
			<p> I expect them to be respectful to me and each other--they get to see my "other side" if they don't, but that is very rare. We stay busy in class--there is little time for getting in trouble. My classes are interactive and students have a chance to work together and learn that we all need encouragement and some healthy competition to improve our skills. I love my students!
			</p> <br />
    </div>
    <div class="ourprojectrow">
            <h6>You homeschooled your own son, K-12. Would you do that again? How did he do in college? </h6>
      <p>
    ...
    <div class="ourprojectrow">
          <h6>​Are there families that do not choose accreditation services, but create their own transcripts? Are their students accepted into colleges?</h6>
      <p>
    ...
    <div class="ourprojectrow">
      ...
      <p>
        Each year, my syllabus is updated and approved by the College Board.
      </p><br/>
    </div>
    ...
    <div class="ourprojectrow">
      ...
      <p>
      To have "AP" on one's transcript, your instructor must be approved by the College Board. Students often get 5-10 pts added to their GPA course value for an AP class. Students also have the opportunity to sit for AP exams given only in May. Though the test is not required for one to receive class credit, and one does not need to take an AP class to take an AP exam, an exam with a good score can reward students course credit in college. A talk with college representatives or a look at a college website can determine how valuable AP classes and tests may be for a student. Some universities offer credit for up to two English classes for a good score on the AP English exam.
      </p> <br />
    </div>

    <div class="ourprojectrow">
      <h6>What is the difference between AP English Literature and Composition and AP English Language and Composition? </h6>
      <p>
    ...
    <div class="ourprojectrow">
            <h6>Can my student take AP class and not take the national exam? </h6>
      <p>
      Yes. We do a number of practice tests during the year and if this is not a good type of test for a student, he or she can opt out of taking it. One can also take the exam without taking the class.
      </p> <br />
    </div>
    <!-- <div class="ourprojectrow">
      <h6></h6>

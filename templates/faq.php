<?php include('deps/m_header.php'); ?>
  ...
  <div class="ourprojectrow">
    ...
    <p>
      I've been prepping for that and will be assigning practice in each of my classes.
    </p><br/>
  </div>
